...
import { ExternalIdParam } from '@/features/user/types/user.api.request.type';
import { BaseInfo, ProfileInfo, StatsInfo } from '@/features/user/types/user.api.response.type';
