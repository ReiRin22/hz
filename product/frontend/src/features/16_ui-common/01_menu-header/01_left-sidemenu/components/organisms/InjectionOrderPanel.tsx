...
import { Search, Plus, Calendar, Check, X, Copy, Users, Building } from 'lucide-react';
import { InjectionDetailDialog } from '../molecules/InjectionDetailDialog';
import { OutpatientInjectionLeftPanel } from '../molecules/OutpatientInjectionLeftPanel';
import { OutpatientInjectionCenterPanel } from '../molecules/OutpatientInjectionCenterPanel';
import { OutpatientInjectionRightPanel } from '../molecules/OutpatientInjectionRightPanel';
...
import type { OrderItem, OrderSet, FrequentOrderItem } from '../../types/order.types';

// 注射薬のモックデータ
const mockInjectionDrugs: OrderItem[] = [
  { id: 'inj1', name: '生理食塩液500ml', dosage: '500ml', usage: '点滴静注 100ml/h' },
  { id: 'inj2', name: 'ソルデム3A輸液500ml', dosage: '500ml', usage: '点滴静注 80ml/h' },
  { id: 'inj3', name: 'ラクテック注500ml', dosage: '500ml', usage: '点滴静注 120ml/h' },
  { id: 'inj4', name: 'ペンタジン注15mg', dosage: '15mg', usage: '筋肉内注射' },
  { id: 'inj5', name: 'アタラックス-P注25mg', dosage: '25mg', usage: '筋肉内注射' },
  { id: 'inj6', name: 'メイロン注7%20ml', dosage: '20ml', usage: '静脈内注射' },
  { id: 'inj7', name: 'KCL注20mEq/20ml', dosage: '20ml', usage: '点滴内混注' },
  { id: 'inj8', name: 'セファゾリン注1g', dosage: '1g', usage: '静脈内注射' },
  { id: 'inj9', name: 'フェンタニル注0.1mg', dosage: '0.1mg', usage: '静脈内注射' },
  { id: 'inj10', name: 'ミダゾラム注10mg', dosage: '10mg', usage: '静脈内注射' }
];

// 注射履歴のモックデータ
const mockInjectionHistory = [
  {
    date: '2024-12-14',
    department: '内科',
    complaint: '脱水症状',
...
// 注射セットのモックデータ  
const mockInjectionSets: OrderSet[] = [
  {
    id: 'fluid-set',
    name: '基本輸液セット',
    items: [
...
// 頻用注射薬のモックデータ
const mockFrequentInjections: FrequentOrderItem[] = [
...
// 薬効カテゴリのモックデータ（注射薬版）
const mockInjectionCategories = [
  {
    id: 'fluids',
    name: '輸液製剤',
    description: '脱水・電解質補正',
    drugs: [
      { id: 'fluid1', name: '生理食塩液500ml', dosage: '500ml', usage: '点滴静注 100ml/h' },
      { id: 'fluid2', name: 'ソルデム3A輸液500ml', dosage: '500ml', usage: '点滴静注 80ml/h' },
      { id: 'fluid3', name: 'ラクテック注500ml', dosage: '500ml', usage: '点滴静注 120ml/h' }
    ]
  },
  {
    id: 'analgesics',
    ...
    description: '疼痛管理',
    drugs: [
      { id: 'pain1', name: 'ペンタジン注15mg', dosage: '15mg', usage: '筋肉内注射' },
      { id: 'pain2', name: 'フェンタニル注0.1mg', dosage: '0.1mg', usage: '静脈内注射' }
    ]
  },
  {
    id: 'antibiotics',
    ...
    description: '感染症治療',
    drugs: [
      { id: 'abx1', name: 'セファゾリン注1g', dosage: '1g', usage: '静脈内注射' },
      { id: 'abx2', name: 'バンコマイシン注0.5g', dosage: '0.5g', usage: '点滴静注' }
    ]
  },
  {
    id: 'electrolytes',
    ...
    description: '電解質補正',
    drugs: [
      { id: 'elec1', name: 'KCL注20mEq/20ml', dosage: '20ml', usage: '点滴内混注' },
      { id: 'elec2', name: 'メイロン注7%20ml', dosage: '20ml', usage: '静脈内注射' }
    ]
  }
];
