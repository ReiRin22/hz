...
import { CheckCircle, BarChart3, Bell, UserPlus, Grid3X3 } from "lucide-react";
...
interface MainContentTabsProps {
  ...
  currentPatient: any;
  selectedRecord: any;  // Record | Record[] | undefined
  currentRecord: any;
  orders: any[];
...
export function MainContentTabs({
  ...
  return (
    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
      ...
      <TabsContent value="records" className="mt-1">
