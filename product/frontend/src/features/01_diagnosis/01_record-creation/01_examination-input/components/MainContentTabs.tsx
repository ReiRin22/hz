            ...
            <div className="flex flex-col gap-3 h-full">
              <div className="flex gap-3 min-h-0 flex-1">
                ...
                <div className="w-[15%] min-h-0">
                  <HamburgerMenu
                    onDocumentCreate={onDocumentCreate || (() => console.log("文書作成"))}
                    onTemplateLoad={onTemplateLoad || (() => console.log("テンプレート読込"))}
                    onExternalRecordsView={onExternalRecordsView}
                    onHealthCheckupView={onHealthCheckupView}
                    onDiagnosisRegistration={onDiagnosisRegistration}
                    onMedicationHistoryView={onMedicationHistoryView}
                    onImageViewing={onImageViewing}
                    onTestResultsView={onTestResultsView}
