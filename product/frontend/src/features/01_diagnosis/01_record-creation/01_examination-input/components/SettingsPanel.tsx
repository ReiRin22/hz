...
import { Settings, Moon, Sun, Shield, Bell, Save, Keyboard, Timer, Clock, Type } from "lucide-react";
...
export function SettingsPanel({
  ...
  const fontSizeOptions = [
    { value: "normal", label: "標準（14px）", scale: 1.0 },
    { value: "large", label: "大（17.5px）", scale: 1.25 },
    { value: "xlarge", label: "特大（21px）", scale: 1.5 },
  ];
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm">画面全体の文字サイズ</span>
          </div>
          <Select
            value={fontSize}
