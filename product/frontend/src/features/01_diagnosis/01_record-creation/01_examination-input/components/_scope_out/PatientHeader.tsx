...
export function PatientHeader({
  ...
  const [showDetailDialog, setShowDetailDialog] =
    useState(false);
  const [showDiagnosisDialog, setShowDiagnosisDialog] =
    useState(false);
  const [showMedicationDialog, setShowMedicationDialog] =
    useState(false);
  const [showImageViewerDialog, setShowImageViewerDialog] =
    useState(false);
  const [showTestResultsDialog, setShowTestResultsDialog] =
    useState(false);
  const [showPatientSearchDialog, setShowPatientSearchDialog] =
    useState(false);
  const [
    showPrescriptionSettingsDialog,
    setShowPrescriptionSettingsDialog,
  ] = useState(false);
  const [
    showMedicalInfoSharingDialog,
    setShowMedicalInfoSharingDialog,
  ] = useState(false);
  ...
  const handlePrescriptionStatusChange = (
    ...
    console.log(
      `処方箋ステータス変更: ${patient.patientId} → ${newStatus}`,
    );
  ...
  return (
    <>
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <Avatar
                  className={`w-16 h-16 ${getGenderColor(patient.gender)} border-4 border-white dark:border-gray-800 shadow-lg`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <Badge
                    variant="outline"
                    className="border-orange-200 text-orange-700 bg-orange-50 dark:border-orange-800 dark:text-orange-300 dark:bg-orange-950 text-xs"
                  >
              ...
              <div className="space-y-2">
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        ...
                        <Badge
                          className={`border ${statusInfo.color} text-xs`}
                        >
                          {statusInfo.label}
                        </Badge>
                      </>
                ...
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <PrescriptionStatusBadge
                    status={
                      patient.prescriptionStatus || "electronic"
                    }
                    onClick={() =>
                      setShowPrescriptionSettingsDialog(true)
                    }
                  />
                </div>
                ...
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <div
                    onClick={() =>
                      setShowMedicalInfoSharingDialog(true)
                    }
              ...
              {patient.allergies.length > 0 && (
                <div className="flex items-center space-x-1 p-1.5 bg-red-50 dark:bg-red-950/50 border border-red-200 dark:border-red-800 rounded-md shadow-sm">
                  ...
                  <div className="flex flex-col">
                    <Badge
                      variant="destructive"
                      className="text-xs font-medium mb-0.5 px-1 py-0 text-[12px]"
                    >
                      アレルギー
                    </Badge>
      ...
      <MedicalInfoSharingDialog
        ...
        patientName={patient.name}
        currentData={
          patient.medicalInfoSharing || { status: "no-consent" }
        }
