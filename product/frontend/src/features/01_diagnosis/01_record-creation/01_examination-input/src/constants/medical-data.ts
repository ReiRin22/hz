...
export const sampleProgressRecords: ProgressRecord[] = [
  {
    ...
    department: "循環器内科",
    isImportant: true,
    createdAt: "2026-01-27T14:30:00+09:00", // 編集可能期間内（2日前）
  },
  {
    id: "prog2",
    date: "2026/01/27",
    ...
    department: "循環器内科",
    isImportant: false,
    createdAt: "2026-01-27T12:15:00+09:00", // 編集可能期間内（2日前）
  },
  {
    id: "prog3",
    date: "2026/01/26",
    ...
    department: "循環器内科",
    isImportant: false,
    createdAt: "2026-01-26T18:45:00+09:00", // 編集可能期間内（3日前）
  },
  {
    id: "prog4",
    date: "2025/11/20",
    ...
    department: "循環器内科",
    isImportant: true,
    createdAt: "2025-11-20T15:20:00+09:00", // 編集可能期間超過（70日前）
  },
];
