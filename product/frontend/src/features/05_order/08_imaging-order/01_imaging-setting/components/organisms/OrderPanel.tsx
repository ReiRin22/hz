...
/**
 * 右パネル - 画像検査オーダーリスト（specimen セクションなし）
 */

import { useState } from 'react';
import { Plus } from 'lucide-react';
import { Button } from '@/shared/components/atoms/button';
import { ContrastAllergyConfirmDialog } from '../molecules/ContrastAllergyConfirmDialog';
...
import type { ImagingPanelProps, OrdersByType } from '../../types/imaging-panel.types';

export type { ImagingPanelProps };
            ...
            {Object.entries(ordersByType).map(([orderType, orders]) => {
              ...
              return (
                <OrderTypeSection
                  ...
                  onAddNewOrder={
                    orderType === 'imaging' ? handleAddNewImagingOrder : undefined
                  }
                  onEdit={handleEdit}
