...
import { Shield, ShieldCheck, ShieldX, Check, Info, AlertTriangle, MessageCircle } from "lucide-react";
...
import type { MedicalInfoSharingStatus } from "@/shared/components/molecules/patient-header/MedicalInfoSharingBadge";
...
export function MedicalInfoSharingDialog({
  ...
  const statusOptions = [
    ...
    {
      value: "verbal-consent" as MedicalInfoSharingStatus,
      icon: MessageCircle,
      title: "口頭同意",
      description: "口頭で同意を確認",
      color: "border-blue-300 bg-blue-50 dark:border-blue-600 dark:bg-blue-800/50",
