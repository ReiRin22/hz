                  ...
                  <div className="space-y-4">
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        {/* プリセット */}
                        {currentImage && windowPresets[currentImage.modality as keyof typeof windowPresets] && (
                          <div className="space-y-2">
                            <Label className="text-xs">プリセット</Label>
                            <div className="grid grid-cols-1 gap-1">
                              {windowPresets[currentImage.modality as keyof typeof windowPresets].map((preset: { name: string; width: number; center: number }, index: number) => (
                                <Button
                                  key={index}
                                  variant="outline"
                                  size="sm"
