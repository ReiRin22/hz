...
} from "@/shared/hooks/patient-header/use-patient-header";
import { usePatientHeaderStore } from "@/shared/stores/use-patient-header.store";
import { PatientAvatarMolecule } from "@/shared/components/molecules/patient-header/PatientAvatarMolecule";
import { PatientInfoGridMolecule } from "@/shared/components/molecules/patient-header/PatientInfoGridMolecule";
import { PatientAlertsMolecule } from "@/shared/components/molecules/patient-header/PatientAlertsMolecule";
import { PrivacyModePanelMolecule } from "@/shared/components/molecules/patient-header/PrivacyModePanelMolecule";
import { NewPatientBadge } from "@/shared/components/molecules/patient-header/NewPatientBadge";
...
export function PatientHeaderOrganism({ patientId = "P001" }: { patientId?: string }) {
  // ストアから状態取得
  ...
  // フック呼び出し
  usePatientHeaderInit(patientId);
