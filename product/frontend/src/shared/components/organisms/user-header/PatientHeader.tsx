...
export function PatientHeader({
  ...
  return (
    <>
      <Card className="w-full min-h-28 flex items-center px-8 mb-6 bg-gradient-to-r from-white via-gray-50/80 to-white dark:from-gray-900 dark:via-gray-800/80 dark:to-gray-900 border-0 shadow-lg backdrop-blur-sm relative overflow-hidden">
        {/* 背景装飾 */}
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'linear-gradient(to right, var(--color-medical-primary-bg), var(--color-medical-primary-bg))' }} />
        <div className="absolute top-0 left-0 w-full h-1" style={{ background: 'linear-gradient(to right, var(--color-medical-primary), var(--color-medical-primary-dark))' }} />
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex flex-col">
                ...
                <div className="mt-2 mb-1">
                  <Badge 
                    variant="outline" 
                    className="text-[12px] medical-border-primary medical-text-primary medical-bg-primary cursor-pointer hover:medical-bg-primary transition-colors group"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-2 mt-3">
              ...
              <div className="space-y-2">
                ...
                {patient.referringDoctor && (
                  <div className="flex items-center space-x-2 text-sm">
                    <span className="text-muted-foreground">指示医:</span>
