...
import type { 
  ...
  SetCategory,
  SetApplyOptions
} from "@/shared/types/user-header/set-registration-types";
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden">
          <DialogHeader>
            ...
            <DialogDescription>
              診療効率を向上させるためのセット登録機能を管理できます。よく使用する診療行為、所見、病名などを一括で登録・適用することで、入力時間の短縮と医療安全の向上を図ります。
            </DialogDescription>
          </DialogHeader>
