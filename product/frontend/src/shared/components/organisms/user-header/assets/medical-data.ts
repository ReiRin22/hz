...
export const initialUserAlerts: UserAlert[] = [
  {
    ...
    type: 'warning',
    title: '代行入力承認依頼',
    message: '看護師 山田花子さんが患者ID:0012345の代行入力力承認依頼があります。内容を確認の上、承認または否認をお願いします。',
    priority: 'high',
    timestamp: '46分前',
    dismissed: false,
  ...
  },
  {
    ...
    type: 'notification',
    title: '緊急：検査結果確認依頼',
    message: '患者ID:0045678の血液検査結果で異常値が検出されました。CRP 15.2mg/dL、WBC 18,500/μL。早急な確認と対応をお願いします。',
    priority: 'high',
    timestamp: '31分前',
    dismissed: false,
    userId: currentUser.id
  },
  {
    ...
    type: 'warning',
    title: '代行入力差し戻し通知',
    message: '2025/01/15 14:30の代行入力が差し戻されました。理由：SOAP記録のA欄に記載不足があります。再度記載をお願いします。',
    priority: 'high',
    timestamp: '1時間前',
    dismissed: false,
    userId: currentUser.id
  },
  {
    ...
    type: 'system',
    title: '予約患者リマインダー',
    message: '本日15:00予約の患者 佐藤太郎様（ID:0078901）の来院予定時刻が近づいています。カルテの事前確認をお願いします。',
    priority: 'medium',
    timestamp: '1時間前',
    dismissed: false,
    userId: currentUser.id
  },
  {
    ...
    type: 'task',
    title: '代行入力承認完了',
    message: '患者ID:0023456の代行入力が承認されました。記録は電子カルテに反映されています。ご確認ください。',
    priority: 'low',
    timestamp: '2時間前',
    dismissed: false,
    userId: currentUser.id
  },
  {
    ...
    message: '本日23:00-24:00にシステムメンテナンスを実施します。この時間帯はシステムをご利用いただけません。事前にデータの保存をお願いします。',
    priority: 'medium',
    timestamp: '3時間前',
    dismissed: false,
    userId: currentUser.id
  },
  {
    ...
    type: 'warning',
    title: '一時保存データ期限警告',
    message: '2件の一時保存データが7日間保存されています。保存期限は10日間です。必要なデータは正式に保存してください。',
    priority: 'high',
    timestamp: '4時間前',
    dismissed: false,
    userId: currentUser.id
  },
  {
    ...
    type: 'system',
    title: '病床稼働率アラート',
    message: '内科病棟の病床稼働率が95%に達しています。新規入院受け入れの際は、病床管理部門との調整をお願いします。',
    priority: 'medium',
    timestamp: '5時間前',
    dismissed: false,
    userId: currentUser.id
  },
  {
    ...
    type: 'task',
    title: 'システムアップデート完了',
    message: 'Harz医療システムのバージョン2.5.0へのアップデートが完了しました。新機能：検査結果グラフ表示、音声入力機能の強化。',
    priority: 'low',
    timestamp: '1日前',
    dismissed: true,
    userId: currentUser.id
  },
  {
    ...
    type: 'system',
    title: '新機能追加のお知らせ',
    message: 'PACS連携機能が追加されました。放射線画像・MRI画像を外部ビューワで参照できるようになりました。詳細はヘルプをご確認ください。',
    priority: 'low',
    timestamp: '2日前',
    dismissed: true,
    userId: currentUser.id
