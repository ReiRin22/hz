...
// サブコンポーネントのインポート
import { InputAssistToolbar } from "@/shared/components/organisms/user-header/InputAssistToolbar";
import { VoiceInputControls } from "@/shared/components/organisms/user-header/VoiceInputControls";
import { AbbreviationSuggestions } from "@/shared/components/organisms/user-header/AbbreviationSuggestions";
import { PredictiveTextDisplay } from "@/shared/components/organisms/user-header/PredictiveTextDisplay";
import { ContextSuggestionsPanel } from "@/shared/components/organisms/user-header/ContextSuggestionsPanel";
import { GuidelineCheckPanel } from "@/shared/components/organisms/user-header/GuidelineCheckPanel";
import { LearningInsights } from "@/shared/components/organisms/user-header/LearningInsights";

// 型定義のインポート
import type { MedicalRecord } from "@/shared/types/user-header";
