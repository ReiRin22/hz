import type { PrescriptionStatusUpdateRequest } from '@/front_bff_shared/features/karte/patientInfo/types/requests/patient.request';
...
export async function putPrescriptionStatus(
  ...
  const res = await fetch(
    `${BFF_BASE_URL}/bff/patients/${encodeURIComponent(body.patientId)}/prescription-status`,
    {
      method: 'PUT',
