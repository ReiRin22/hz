import type { MedicalInfoSharingUpdateRequest } from '@/front_bff_shared/features/karte/patientInfo/types/requests/patient.request';
...
export async function putMedicalInfoSharing(
  ...
  const res = await fetch(
    `${BFF_BASE_URL}/bff/patients/${encodeURIComponent(patientId)}/medical-info-sharing`,
    {
      method: 'PUT',
